...
Run:
    ...
    MUJOCO_GL=osmesa python examples/demos/sonic/locomotion.py
...
# ---------------------------------------------------------------------------
# G1 MuJoCo environment (same model family as the G1 locomotion demo)
# ---------------------------------------------------------------------------
...
def generate_html_report(output_dir: Path) -> Path:
    ...
    return _generate(
        ...
        footer_text="Generated by <code>examples/demos/sonic/locomotion.py --report</code>",
        meshcat_mode="none",
    )
