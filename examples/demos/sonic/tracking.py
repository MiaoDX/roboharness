...
Run:
    ...
    MUJOCO_GL=osmesa python examples/demos/sonic/tracking.py --report --assert-success
...
def generate_html_report(
    ...
    return _generate(
        ...
        footer_text="Generated by <code>examples/demos/sonic/tracking.py --report</code>",
        meshcat_mode="none",
