...
Run:
    MUJOCO_GL=osmesa python examples/demos/g1/lerobot_native.py --controller groot
    MUJOCO_GL=osmesa python examples/demos/g1/lerobot_native.py --controller sonic
...
def generate_html_report(output_dir: Path, task_name: str, controller: str) -> Path:
    ...
    return _generate(
        ...
        footer_text=(
            "Generated by <code>examples/demos/g1/lerobot_native.py "
            f"--controller {controller}</code>"
        ),
        meshcat_mode="none",
    )
